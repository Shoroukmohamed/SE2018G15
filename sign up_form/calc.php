...
if (isset($_POST['submit'])) {  
    ...
    if ($conn->connect_error) {  
      ...
      $sql = "INSERT Into calc (anemia, sugar, pressure, weight, week,email) values('$anemia','$sugar','$pressure','$weight','$week','$email')";
        ...
        <div class="col-10">
          ...
          <form class="quick-tests mt-4"action="" method="POST" >
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <input type="text" name="sugar" class="form-control form-control-sm" id="sugar" required>
              </div>
